        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <OrderManagementPayment :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "paymentStatusType", value: "paymentStatusType" },
                    { text: "paymentTime", value: "paymentTime" },
                    { text: "earnedPoints", value: "earnedPoints" },
                ],
            payment : [],
            newValue: {},
            tick : true,

<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <RiderId offline label="RiderId" v-model="item.riderId" :editMode="false" :key="false" @change="change" />
            <LocalDateTime offline label="PickupTime" v-model="item.pickupTime" :editMode="false" :key="false" @change="change" />
            <div>
                <String label="DeliveryStatus" v-model="item.deliveryStatus" :editMode="editMode" @change="change" />
            </div>
            <deliveryStatusType offline label="DeliveryStatusType" v-model="item.deliveryStatusType" :editMode="false" :key="false" @change="change" />
        </v-card-text>

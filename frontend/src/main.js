...
pluralCaseList.push( {plural: "customerManagements/customers", pascal: "CustomerManagementCustomer"} )

pluralCaseList.push( {plural: "orderManagements/stores", pascal: "OrderManagementStore"} )
pluralCaseList.push( {plural: "orderManagements/orders", pascal: "OrderManagementOrder"} )
pluralCaseList.push( {plural: "orderManagements/payments", pascal: "OrderManagementPayment"} )

pluralCaseList.push( {plural: "deliveryManagements/riders", pascal: "DeliveryManagementRider"} )
pluralCaseList.push( {plural: "deliveryManagements/deliveries", pascal: "DeliveryManagementDelivery"} )

pluralCaseList.push( {plural: "notificationManagements/notifications", pascal: "NotificationManagementNotification"} )

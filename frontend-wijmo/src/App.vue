...
export default {
    ...
    data: () => ({
        ...
        urlPath: null,
        menus: [
            { id: 'customerManagement', title: '고객 관리',
                items: [
                    { key: 'customers', url: '/customers', name: '고객' },
                ]
            },
            { id: 'orderManagement', title: '주문 관리',
                items: [
                    { key: 'stores', url: '/stores', name: '상점' },
                    { key: 'orders', url: '/orders', name: '주문' },
                    { key: 'payments', url: '/payments', name: '결제' },
                ]
            },
            { id: 'deliveryManagement', title: '배달 관리',
                items: [
                    { key: 'riders', url: '/riders', name: '라이더' },
                    { key: 'deliveries', url: '/deliveries', name: '배달' },
                ]
            },
            { id: 'notificationManagement', title: '알림 관리',
                items: [

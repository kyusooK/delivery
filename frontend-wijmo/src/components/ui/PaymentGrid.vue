<template>
    <div style="max-height:80vh;">
        ...
        >
            ...
            <wj-flex-grid-column binding="paymentTime" header="결제 시간" width="2*" :isReadOnly="true" align="center" />
                ...
                <template>
                    <v-card>
                        <v-toolbar
                            ...
                            height="50px"
                        >
                            <div style="color:white; font-size:17px; font-weight:700;">결제 등록</div>
                            <v-spacer></v-spacer>
                            <v-icon
                                color="white"
                                small
